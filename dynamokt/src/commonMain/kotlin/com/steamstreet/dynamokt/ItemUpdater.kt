...
public interface ItemUpdater {
     ...
     */
    public suspend fun put(pk: String, sk: String?, block: suspend MutableItem.() -> Unit = {}): Item =
        put(pk.attributeValue(), sk?.attributeValue(), block)

    /**
     * Pu an update using attribute values for the key.
     */
    public suspend fun put(pk: AttributeValue, sk: AttributeValue?, block: suspend MutableItem.() -> Unit = {}): Item
     ...
     * Update an item
     */
    public suspend fun update(entity: Item, block: suspend MutableItem.() -> Unit = {}): Item =
     ...
     */
    public suspend fun delete(pk: String, sk: String?, block: suspend MutableItem.() -> Unit = {})
